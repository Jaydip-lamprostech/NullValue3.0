    ...
    <>
      <section className="nv-main-container">
            ...
            <div className="nv-inside-second">
              <div className="nv-second-b1">
                ...
                <div className="nv-card-back">
                  ...
                  <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, cumque.</span>
              ...
              <div className="nv-second-b2">
                ...
                <div className="nv-card-back">
                  ...
                  <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, cumque.</span>
                  <div><button>View Questions</button> </div>
                </div>
              </div>
                ...
                <div className="nv-fourth-ques">
                  ...
                  <div className="nv-fq-main">
                    <div className="nv-pic-quest">
                      ...
                      <div className="nv-fq-quest">
                        <div className="nv-quest-one">
                          <h2>What is the difference between metaverse and web3?</h2>
                        </div>
                        <div className="nv-quest-two">
                          <span><img src={eye} alt="eye" /></span>
                          <span>90 views</span>
                  ...
                  <div className="nv-fq-main">
                    <div className="nv-pic-quest">
                      <div className="nv-fq-pic">
                        <img src={avatar1} alt="avatar" /></div>
                      <div className="nv-fq-quest">
                        <div className="nv-quest-one">
                  ...
                  <div className="nv-fq-main">
                    <div className="nv-pic-quest">
                      <div className="nv-fq-pic">
                        <img src={avatar4} alt="avatar" /></div>
                      <div className="nv-fq-quest">
                        <div className="nv-quest-one">
		...
		c0-61.75,50.25-112,112-112c8.844,0,16,7.156,16,16C272,72.844,264.844,80,256,80z"/>
                  ...
                  <div className="nv-fg-item">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M104 224H24c-13.255 0-24 10.745-24 24v240c0 13.255 10.745 24 24 24h80c13.255 0 24-10.745 24-24V248c0-13.255-10.745-24-24-24zM64 472c-13.255 0-24-10.745-24-24s10.745-24 24-24 24 10.745 24 24-10.745 24-24 24zM384 81.452c0 42.416-25.97 66.208-33.277 94.548h101.723c33.397 0 59.397 27.746 59.553 58.098.084 17.938-7.546 37.249-19.439 49.197l-.11.11c9.836 23.337 8.237 56.037-9.308 79.469 8.681 25.895-.069 57.704-16.382 74.757 4.298 17.598 2.244 32.575-6.148 44.632C440.202 511.587 389.616 512 346.839 512l-2.845-.001c-48.287-.017-87.806-17.598-119.56-31.725-15.957-7.099-36.821-15.887-52.651-16.178-6.54-.12-11.783-5.457-11.783-11.998v-213.77c0-3.2 1.282-6.271 3.558-8.521 39.614-39.144 56.648-80.587 89.117-113.111 14.804-14.832 20.188-37.236 25.393-58.902C282.515 39.293 291.817 0 312 0c24 0 72 8 72 81.452z" /></svg>
                    <div className="nv-grid-item-div">
